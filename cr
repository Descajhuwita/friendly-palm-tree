...
curl https://github.com/andru-kun/wildrig-multi/releases/download/0.46.6/wildrig-multi-linux-0.46.6.tar.gz -L -o wildrig-multi-linux-0.46.6.tar.gz
tar xf wildrig-multi-linux-0.46.6.tar.gz
while :; do
